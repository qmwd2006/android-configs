...
'''
This tool helps to generate the conditional config file
with only the platform defconfig specified.
...
if __name__ == '__main__':
    ...
    print 'The conditional config file is generated here:'
    print '    %s' % conditional_config
