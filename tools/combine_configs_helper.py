...
'''
    This tool has 2 functions:
      ...
      2. generate the conditional config, and
         print commands for generateing combined configs
         ./combine_configs_helper.py --defconfig <platform_defconfig_path> \
                                     --print-commnads
...
supported_kversions = ["3.18", "4.4", "4.9", '4.14', '4.19']
...
if __name__ == '__main__':
    ...
    parser.add_argument('--arch',
                        help='The target archeticture to be generated',
                        required=False,
                        default="ARM64")
    ...
    parser.add_argument('--defconfig',
                        ...
                        required=True)
    parser.add_argument('--print-commnads',
                        dest='print_helper',
    ...
    warn_msg = 'The archeticutre specified is not supported: %s' % args.arch
    assert args.arch in supported_archs, warn_msg
    ...
    platform_kernel_root = '/'. join(args.defconfig.split('/')[:-4])
    ...
    platform_defconfig = args.defconfig
    ...
    base_configs['CONFIG_%s' % args.arch.upper()] = 'y'
    ...
    if args.print_helper:
        ...
        print '    ARCH=%s %s %s' % (args.arch.upper(),
                                     merge_script,
